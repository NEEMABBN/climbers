...
export default function EachToursPost({
  ...
  return (
    <div
      onClick={onClick}
      className={`${mb} cursor-pointer flex bg-white flex-col items-center gap-2 group p-1 border-solid border-[1px] rounded-2xl hover:shadow-xl transition-all duration-200`}
    >
